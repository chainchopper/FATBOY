...
import { AuthGuard } from './guards/auth.guard'; // Uncommented AuthGuard import
import { AdminGuard } from './guards/admin.guard'; // Uncommented AdminGuard import
...
export const routes: Routes = [
  ...
  { 
    path: 'admin', 
    canActivate: [AdminGuard], // Uncommented AdminGuard
    children: [
