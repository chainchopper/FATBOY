...
// import { AuthGuard } from './guards/auth.guard'; // Commented out AuthGuard import
// import { AdminGuard } from './guards/admin.guard'; // Commented out AdminGuard import
...
export const routes: Routes = [
  ...
  { 
    path: 'admin', 
    // canActivate: [AdminGuard], // Commented out AdminGuard
    children: [
